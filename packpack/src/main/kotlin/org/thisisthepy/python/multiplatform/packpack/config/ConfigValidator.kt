...
class ConfigValidator {
    ...
    private fun validateProjectSection(
    ...
    private fun validateBuildSystemSection(
    ...
    private fun validateToolSection(
        tool: ToolConfig?,
        errors: MutableList<String>,
        warnings: MutableList<String>,
    ) {
    ...
    private fun validatePyPackPackConfig(
        config: PyPackPackConfig,
        errors: MutableList<String>,
        warnings: MutableList<String>,
    ) {
        // Validate version
